...
export default function MonitoringReportingClient() {
  return (
    <main className="px-4 pt-32 md:pt-40 pb-12 md:px-6 max-w-5xl mx-auto text-white">
      <motion.section
      ...
      >
        <h1 className="text-3xl md:text-4xl font-bold flex items-center gap-3">
          <FaChartLine className="text-gold-300" /> Monitoring & Reporting
        </h1>
        ...
        <div className="bg-primary-light border border-gold-300/20 rounded-xl p-6">
        ...
        <div className="space-y-6">
          ...
          <div>
            <p className="font-semibold text-white">Wie oft erhalte ich Reports?</p>
            <p className="text-gray-300">Standardmäßig einmal im Monat. Auf Wunsch auch wöchentlich oder täglich bei kritischen Entwicklungen.</p>
          </div>
          <div>
            <p className="font-semibold text-white">Sind die Dashboards in Echtzeit?</p>
            <p className="text-gray-300">Ja. Wir nutzen APIs und Schnittstellen, um Live-Daten direkt ins Dashboard zu ziehen.</p>
          </div>
          <div>
            <p className="font-semibold text-white">Kann ich eigene KPIs einbauen?</p>
            <p className="text-gray-300">Absolut. Unsere Dashboards sind vollständig anpassbar an deine Ziele und Reporting-Vorlieben.</p>
          </div>
        </div>
        ...
        <div className="mt-6">
          <Link 
            href="/kontakt" 
            className="inline-flex items-center gap-2 bg-gold-300 text-white px-6 py-3 rounded-full font-semibold shadow hover:bg-blue-700 transition"
          >
