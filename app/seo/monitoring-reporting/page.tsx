  ...
  return (
    <main className="px-4 py-12 md:px-6 max-w-5xl mx-auto text-blue-900">
      ...
      >
        ...
        <div className="mt-6">
          <Link href="/kontakt" className="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-full font-semibold shadow hover:bg-blue-700 transition">
