  ...
  return (
    <section className="relative isolate bg-[#0c1832] text-white py-24 md:py-36 px-4 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        >
          Als Ihre führende <strong className="text-white">Google Ads Agentur Berlin</strong> generieren wir <strong className="text-white">mehr Leads & Umsatz</strong> durch hochperformante Kampagnen, die nicht nur Klicks bringen, sondern echte Kunden. Zielgerichtet. Messbar. Skalierbar.
        </motion.p>
