  ...
  return (
    <section className="bg-white py-24 px-6 text-gray-800 leading-relaxed text-lg">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <h3 className="text-2xl font-semibold text-gray-900">Was unsere Social Media Agentur in Berlin besonders macht</h3>
        ...
        <p>
          <strong>Suchmaschinenoptimierter Content</strong> gehört ebenso zu unserem Ansatz wie die gezielte Kombination mit <a href="/google-ads" className="text-blue-600 hover:underline">Google Ads</a> und <a href="/seo" className="text-blue-600 hover:underline">SEO</a>. So schaffen wir kanalübergreifende Markenwelten und mehr Sichtbarkeit im digitalen Raum.
        </p>

        <p>
          Bereit für echtes Wachstum? Als <strong>Social Media Agentur aus Berlin</strong> setzen wir auf messbare Erfolge. Wir beraten Sie gerne in einem kostenlosen Erstgespräch!
        </p>
      </div>
    </section>
  );
