      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-20">
          {[
            ...
            >
              <div className="bg-[#fcd066] text-[#0c1832]/10 p-2 rounded-full mt-1 group-hover:bg-[#fcd066] text-[#0c1832]/20 transition-colors">
                <Check className="text-[#fcd066] w-5 h-5" strokeWidth={2} />
              </div>
              <p className="text-gray-100 leading-relaxed">{benefit}</p>
            </motion.div>
          ))}
        </div>
        ...
        <div className="bg-gradient-to-br from-[#1a2a4a] to-[#15203a] border border-blue-500/30 rounded-2xl overflow-hidden mb-20">
          <div className="p-8 md:p-12">
            ...
            >
              <div className="bg-[#fcd066] text-[#0c1832]/10 p-5 rounded-full">
                <BarChart className="text-[#fcd066] w-12 h-12" strokeWidth={1.5} />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <BenefitSection
                icon={<Target className="w-6 h-6 text-[#fcd066]" />}
              ...
              <BenefitSection
                icon={<Star className="w-6 h-6 text-[#fcd066]" />}
              ...
              <BenefitSection
                icon={<RefreshCw className="w-6 h-6 text-[#fcd066]" />}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          <div>
            <h3 className="text-2xl font-bold text-[#fcd066] mb-6 flex items-center gap-3">
              <ShoppingCart className="text-[#fcd066]" />
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-start gap-2 text-gray-100">
                    <Check className="text-[#fcd066] w-5 h-5 flex-shrink-0 mt-0.5" strokeWidth={2} />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
          ...
          <div>
            <h3 className="text-2xl font-bold text-[#fcd066] mb-6 flex items-center gap-3">
              <FileText className="text-[#fcd066]" />
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="bg-gradient-to-r from-blue-500/10 to-cyan-500/10 border border-[#fcd066]/30 rounded-2xl p-8 md:p-12 text-center mb-20"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto mt-8">
            {[
              ...
              <div key={index} className="bg-primary-light p-4 rounded-lg border border-gold-300/20">
                <div className="text-gold-300 font-semibold">{item.title}</div>
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold text-gray-200 mb-6 max-w-3xl mx-auto">
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-4">
        <div className="bg-[#fcd066] text-[#0c1832]/10 p-2 rounded-lg">
          {icon}
        </div>
