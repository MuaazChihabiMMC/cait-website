...
export default function GoogleAdsBenefits() {
  return (
    ...
    <ul className="list-disc ml-6 space-y-2">
      ...
      <li><strong>Kampagnenstruktur:</strong> Performance-orientierter Aufbau von Such-, Display-, Shopping- und Remarketing-Kampagnen.</li>
      <li><strong>Anzeigentexte:</strong> Wir schreiben überzeugende Ads mit klaren USPs & Call-to-Actions.</li>
      <li><strong>Conversion-Tracking:</strong> Einrichtung von Tracking via Google Tag Manager, Analytics & mehr.</li>
      <li><strong>Kontinuierliche Optimierung:</strong> Wir passen Gebote, Anzeigen & Zielgruppen laufend an.</li>
    </ul>
    ...
    <p>
      Google Ads ist kein „Einmal einrichten und vergessen“-System. Wer dauerhaft erfolgreich werben will, muss kontinuierlich analysieren, testen und verbessern. Als deine <strong>SEA Agentur</strong> überwachen wir alle wichtigen KPIs:
    </p>
    <ul className="list-disc ml-6 space-y-2">
      <li>Klickrate (CTR)</li>
    ...
    <h3 className="text-2xl font-semibold text-blue-800 mt-10">Transparenz & Reporting</h3>
    <p>
    ...
    <h3 className="text-2xl font-semibold text-blue-800 mt-10">Deine Vorteile mit CAIT als Google Ads Agentur</h3>
    <ul className="list-disc ml-6 space-y-2">
    ...
    <p>
      Starte jetzt durch mit einer professionellen <strong>Google Ads Agentur Berlin</strong>. Vereinbare ein kostenloses Beratungsgespräch und finde heraus, welches Potenzial in deinem Unternehmen steckt.
    </p>

    <div className="mt-8 text-center">
      <a href="/kontakt" className="inline-block bg-blue-700 hover:bg-blue-800 text-white font-semibold px-8 py-4 rounded-full shadow transition">
