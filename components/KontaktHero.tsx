  ...
  return (
    <section className="relative isolate bg-[#0c1832] py-32 px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-[#fcd066] text-[#0c1832]/30 filter blur-3xl"></div>
        <div className="absolute bottom-1/3 right-1/3 w-80 h-80 rounded-full bg-[#fcd066] text-[#0c1832]/30 filter blur-3xl"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-6">
          <a
            ...
            className="inline-flex items-center justify-center bg-[#fcd066] text-[#0c1832] hover:bg-[#fcd066] text-[#0c1832] text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-blue-500/30 transition-all hover:translate-y-[-2px]"
          >
            <svg xmlns="https://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
