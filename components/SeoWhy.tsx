      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-3xl md:text-4xl font-bold text-[#fcd066]"
          >
          ...
          >
            <h3 className="font-semibold text-[#fcd066] mb-2">Berliner SEO-Fakt:</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {[
            ...
            <motion.div
              ...
              className="bg-[#1a2a4a] border border-[#2d3a5a] p-6 rounded-xl hover:border-[#fcd066] transition-all group"
            >
              <div className="flex items-center mb-3">
                <div className="w-8 h-8 rounded-full bg-blue-900 flex items-center justify-center mr-3 group-hover:bg-[#d4a84a] transition-colors">
                  <span className="text-[#fcd066]">{index + 1}</span>
                </div>
                <h3 className="text-xl font-semibold text-[#fcd066] group-hover:text-gray-200 transition-colors">
                  {benefit.title}
                </h3>
              </div>
              <p className="text-gray-100 pl-11">{benefit.content}</p>
            </motion.div>
          ))}
        </div>
      </div>
      ...
      >
        <div className="flex flex-col md:flex-row items-center gap-6">
          <div className="bg-white/10 p-3 rounded-lg">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 text-[#fcd066]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
