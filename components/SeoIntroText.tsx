      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-blue-100 leading-relaxed max-w-3xl mx-auto">
            Als erfahrene <strong className="text-blue-200">SEO Agentur in Berlin</strong> sorgt CAIT Social Media für Top-Platzierungen in den Suchergebnissen. Wir steigern Ihre Sichtbarkeit durch datenbasierte Strategien, technische Exzellenz und Inhalte, die Kunden wirklich erreichen.
          </p>
        </motion.div>
        ...
        <div className="space-y-6 text-blue-100 text-lg leading-relaxed">
          ...
          >
            Wir begleiten Sie von der Keyword-Recherche über die technische Optimierung bis zur laufenden Analyse und Optimierung Ihrer Rankings. Als <strong className="text-blue-200">SEO Experten aus Berlin</strong> setzen wir auf messbare Ergebnisse und transparente Kommunikation , ganz ohne leere Versprechen.
          </motion.p>
        </div>
      </div>
    </section>
