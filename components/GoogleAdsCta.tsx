  ...
  return (
    <section className="bg-[#0c1832] py-24 px-6 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute bottom-0 right-1/3 w-40 h-40 rounded-full bg-[#fcd066] text-[#0c1832] filter blur-3xl"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="mt-10">
          <a
            href="/kontakt"
            className="inline-block rounded-full bg-[#fcd066] text-[#0c1832] hover:bg-[#d4a84a] text-white px-8 py-4 font-semibold shadow-lg hover:shadow-blue-500/30 transition-all hover:translate-y-[-2px]"
          >
